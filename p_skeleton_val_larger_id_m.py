...
def main():
    pretrained_model_path = '/mnt/jittorjc/results/skeleton_pct2_4096_12000_1e-4_transform_m_v_add_test/best_model_715.pkl'  # 'checkpoints/skeleton_best_model.pkl'
    predict_output_path = '/mnt/jittorjc/predict/val_skeleton_pct2_4096_12000_1e-4_transform_m_v_add_test_final_m'
    ...
    # Predict parameters
    parser.add_argument('--predict_output_dir', type=str, default=predict_output_path,
